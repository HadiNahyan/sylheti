...
class Bpos extends StatefulWidget {
  @override
  State<Bpos> createState() => _BposState();
}

class _BposState extends State<Bpos> {
  bool av(String val){
    if(val=="Available"){
      return true;
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("B+ Doner"),),
        body: Container(
