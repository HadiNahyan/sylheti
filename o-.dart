...
class Oneg extends StatefulWidget {
  @override
  State<Oneg> createState() => _OnegState();
}

class _OnegState extends State<Oneg> {
  bool av(String val){
    if(val=="Available"){
      return true;
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(title: Text("O- Doner"),),
        body: Container(
